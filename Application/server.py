        ...
        if self.path == '/upload':
            ...
            if ctype == 'multipart/form-data':
                ...
                if csv_file.filename:
                    ...
                    # Extract columns_to_display from the form data
                    columns_to_display = form.getvalue('columns_to_display')  # This will be a JSON string
                    columns_to_display = json.loads(columns_to_display)  # Convert it back to a Python list

                    # Process the CSV and generate animation frames as PNGs using the selected columns
                    print(f"Columns to display: {columns_to_display}")
                    animation_file_paths = create_frames(file_path, columns_to_display)
